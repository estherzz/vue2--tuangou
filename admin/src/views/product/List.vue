    ...
    <div class="page-productList">
        ...
        <div class="card-list">
            <el-card v-for="item in data" :key="item._id">
                ...
                <div class="btns">
                    <router-link tag="el-button" :to="'/product/edit/'+item._id" class="el-button--success el-button--small">修改</router-link>
                    <el-button type="danger" size="small" @click="deleteItem(item._id,item.title,item.img)">删除</el-button>
                </div>
            </el-card>
        </div>
        ...
        <div class="my-pagination">
            ...
            <my-button :page="['/product/list/'+(page>1?page-1:1),'/product/list/'+(page+1)]" :title="['上一页','下一页']"></my-button>
